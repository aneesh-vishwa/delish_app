...
//     return stars >= number ? (
//       <div className="starFull" style={styles} alt={number}></div>
//     ) : stars >= halfNumber ? (
//       <div className="starHalf" style={styles} alt={number}></div>
//     ) : (
//       <div className="starEmpty" style={styles} alt={number}></div>
//     );
//   }
